...
export const PRODUCTION_OPTIONS = OPTIONS;
export const QA_OPTIONS = OPTIONS;
export const TRAIT_CATALOG = Object.freeze({
  production:{torso:[...PRODUCTION_OPTIONS.torso]},
  qaOnly:{torso:[]}
});
export const COAT_COLORS = Object.freeze({neutral: null, ginger: [200,142,87], cream: [219,201,164], blue: [131,149,167], chocolate: [126,96,80], black: [72,76,85], lilac: [175,151,171], silver: [190,194,200]});
export const MARK_COLORS = Object.freeze({dark: [82,69,65], white: [237,227,208], cream: [225,211,188], brown: [130,79,48], blue: [80,107,135], pink: [197,140,151], gold: [194,137,65]});
export const EYE_COLORS = Object.freeze({original:null, blue:[80,140,198], gold:[196,142,55], green:[88,151,111]});
export const MUZZLE_COLORS = Object.freeze({base:'base',original:null,cream:[225,211,188]});
export const DEFAULT_CONFIG = Object.freeze({body:'standard', ear:'standard', tail:'standard', bib:'none', face:'none', torso:'none', frontLeft:'none', frontRight:'none', rearLeft:'none', rearRight:'none', tailmark:'none', coat:'neutral', muzzleColor:'base',faceColor:'white', torsoColor:'dark', frontLeftColor:'white', frontRightColor:'white', rearLeftColor:'white', rearRightColor:'white', tailColor:'dark', eyeLeft:'original', eyeRight:'original'});
...
export function normalizeCatIdentity(input={}) {
  const out={...input};
...
export function buildForeheadMask(neutral, earOwned, features) {
...
export function remapCatMask(source, uv) {
...
export function createStandingPose(bank, template) {
...
export function createRestingPose(bank, template, pose) {
...
export function createBodyPose(bank,template,pose,body){
 ...
 */
export function createSlimCrouchingPose(bank,poc) {
 ...
 */
export function createSlimCrouchingChassisV2(bank,poc) {
  const noOp=blank();
  return {
...
export async function loadCatAssets(manifest, baseUrl, decodePng) {
...
export async function createBrowserCatRenderer(manifestUrl, {poseManifestUrls=[]}={}) {
